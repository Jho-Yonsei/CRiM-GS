...
def optimize_test_pose(scene: Scene, gaussians:GaussianModel, pipeline:PipelineParams, bg_color:torch.Tensor, kernel_size:float, num_iter_per_view:int=2000, gamma_correction:bool=False):
    """
...
@torch.no_grad()
def initialize_test_pose(args:ModelParams, scene: Scene, gaussians:GaussianModel, bg_color:torch.Tensor, exclude = [], old_version=False, gamma_correction=False):
    """
